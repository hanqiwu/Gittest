...
{
open INPUT, "temp10.txt" or die "ERROR: cant open file lb10.txt\n";
my @data = ();
my $p = 0;
while(<INPUT>){
...
open F, "testdata.txt" or die "$! Can't create file";
...
{
open INPUT, "othersplit9.txt" or die "ERROR: cant open file lb9.txt\n";
my @data = ();
my $p = 0;
while(<INPUT>){
...
open F, ">testresult.txt" or die "$! Can't create file";
